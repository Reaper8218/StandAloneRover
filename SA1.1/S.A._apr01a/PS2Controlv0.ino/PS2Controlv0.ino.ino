...
const int LEDpin = 4; //green LED is on Digital pin 4
...
SteeringServo.attach(11);// attaches the Steering Servo to pin 7
ServoN1.attach(10);// attaches the Servo 1 to pin 8
